...
pauseScene3 = director:createScene()
...
continueButton = director:createSprite(director.displayCenterX, director.displayCenterY*0.4, "textures/buttons/botonPauseMenuCont.png")
